...
//create card data
var card_data_div= document.createElement('div');
card_data_div.classList.add('cardContent');
...
//append the div's
card_data_div.appendChild(heading);
card_data_div.appendChild(para);
card_div.appendChild(card_data_div);
grid.appendChild(card_div);

var m_grid=document.getElementById('grid');
m_grid.appendChild(grid);
}
